...
app.include_router(runs_api.router, tags=["evaluation"])
app.include_router(pipelines_api.router, tags=["pipelines"])
app.include_router(compare_api.router, tags=["pipelines"])
app.include_router(finetune_api.router, tags=["finetuning"])
app.include_router(chunks_api.router, tags=["chunks"])
app.include_router(evaluations_api.router, tags=["evaluations"])
