...
class CircuitBreaker:
    ...
    async def _close(self) -> None:
        # _close() is only ever called from _on_success() when the
        # circuit was HALF_OPEN (see below) — i.e. every call here is a
        # genuine open->closed recovery, so decrementing unconditionally
        # is correct given this module's actual call pattern.
