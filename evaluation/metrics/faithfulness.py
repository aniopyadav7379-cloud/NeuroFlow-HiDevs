...
async def _evaluate_faithfulness_inner(query: str, answer: str, context: str, client: NeuroFlowClient) -> float:
...
async def evaluate_faithfulness(query: str, answer: str, context: str, client: NeuroFlowClient) -> float:
    with _tracer.start_as_current_span("evaluation.faithfulness") as span:
        span.set_attribute("query_length", len(query))
        score = await _evaluate_faithfulness_inner(query, answer, context, client)
